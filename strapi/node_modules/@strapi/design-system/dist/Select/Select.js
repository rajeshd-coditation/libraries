...
import { SelectList as me } from "./SelectList.js";
import { SelectTags as de } from "./SelectTags.js";
...
import { escapeSelector as P } from "../helpers/escapeSelector.js";
import { useId as be } from "../helpers/useId.js";
import { Popover as ye } from "../Popover/Popover.js";
import { Stack as ge } from "../Stack/Stack.js";
import { sizes as ve } from "../themes/sizes.js";
...
`, z = ({
  ...
  const n = be(H), [h, E] = ee(void 0), $ = pe(h), R = te(null), w = `${n}-label`, b = `${n}-content`, X = typeof m == "string";
  let B;
  ...
  return /* @__PURE__ */ r.createElement(fe, { hint: v, error: m, id: n, required: J }, /* @__PURE__ */ r.createElement(ge, { spacing: d || v || X ? 1 : 0 }, d && /* @__PURE__ */ r.createElement(ue, { action: G }, d), /* @__PURE__ */ r.createElement(ie, { size: Q, hasError: Boolean(m), disabled: s, ref: R }, /* @__PURE__ */ r.createElement(
    ce,
    {
      ref: $,
      labelledBy: `${n} ${w} ${b}`,
  ...
  ), /* @__PURE__ */ r.createElement(Be, { justifyContent: "space-between" }, /* @__PURE__ */ r.createElement(C, null, x && /* @__PURE__ */ r.createElement(A, { paddingLeft: 3, "aria-hidden": !0 }, x), u && /* @__PURE__ */ r.createElement(de, { tags: F, onRemoveTag: O, disabled: s }), /* @__PURE__ */ r.createElement(A, { paddingLeft: 4, paddingRight: 4 }, u ? /* @__PURE__ */ r.createElement(r.Fragment, null, !o || o.length === 0 ? /* @__PURE__ */ r.createElement(_, { ellipsis: !0, id: b, textColor: "neutral600" }, y) : null, /* @__PURE__ */ r.createElement(q, { as: "span", id: b }, f ? f(o) : T || y, o.join(", "))) : /* @__PURE__ */ r.createElement(_, { ellipsis: !0, id: b, textColor: o ? "neutral800" : "neutral600" }, f ? f(o) : T || y, i && /* @__PURE__ */ r.createElement(q, { as: "span" }, o.join(", "))))), /* @__PURE__ */ r.createElement(C, null, (i && o && o.length || !i && o) && S && /* @__PURE__ */ r.createElement(
    le,
    {
      as: "button",
      type: "button",
...
z.propTypes = {
  ...
  size: e.oneOf(Object.keys(ve.input)),
  startIcon: e.element,
  value: e.oneOfType([
