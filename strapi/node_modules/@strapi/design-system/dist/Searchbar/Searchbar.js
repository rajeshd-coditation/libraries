...
`, l = y(({ name: e, size: m, children: p, value: i, onClear: u, clearLabel: d, ...f }, h) => {
  ...
  return /* @__PURE__ */ r.createElement(A, null, /* @__PURE__ */ r.createElement(C, { name: e }, /* @__PURE__ */ r.createElement(I, null, /* @__PURE__ */ r.createElement(F, null, p)), /* @__PURE__ */ r.createElement(
    w,
    {
      ref: R,
      value: i,
      startAction: /* @__PURE__ */ r.createElement(c, null, /* @__PURE__ */ r.createElement(S, { "aria-hidden": !0 })),
      size: m,
