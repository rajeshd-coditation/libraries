import r, { useRef as E, useImperativeHandle as g } from "react";
...
const o = r.forwardRef(
  ({ size: l, startAction: m, endAction: d, name: p, hint: s, error: c, label: t, labelAction: f, id: u, required: b, ...i }, n) => {
    const v = O(u), a = E(null);
    if (!t && !i["aria-label"])
      throw new Error('The TextInput component needs a "label" or an "aria-label" props');
    return g(n, () => ({
      inputWrapperRef: a
    })), /* @__PURE__ */ r.createElement("div", { ref: a }, /* @__PURE__ */ r.createElement(T, { name: p, hint: s, error: c, id: v, required: b }, /* @__PURE__ */ r.createElement(R, { spacing: 1 }, t && /* @__PURE__ */ r.createElement(y, { action: f }, t), /* @__PURE__ */ r.createElement(I, { size: l, ref: n, startAction: m, endAction: d, ...i }), /* @__PURE__ */ r.createElement(A, null), /* @__PURE__ */ r.createElement(F, null))));
  }
);
...
o.propTypes = {
  ...
  required: e.bool,
  size: e.oneOf(Object.keys(h.input)),
