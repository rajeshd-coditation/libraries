...
`, d = k(({ endAction: e, startAction: o, disabled: a, onChange: f, size: s, ...g }, b) => {
  const { id: n, error: l, hint: h, name: $, required: y } = I();
  let i;
  l ? i = `${n}-error` : h && (i = `${n}-hint`);
  const p = Boolean(l), w = (R) => {
    a || f(R);
  };
  return /* @__PURE__ */ t.createElement(F, { size: s, justifyContent: "space-between", hasError: p, disabled: a }, o && /* @__PURE__ */ t.createElement(c, { paddingLeft: 3, paddingRight: 2 }, o), /* @__PURE__ */ t.createElement(
    E,
    {
      id: n,
      name: $,
  ...
  ), e && /* @__PURE__ */ t.createElement(c, { paddingLeft: 2, paddingRight: 3 }, e));
});
...
d.propTypes = {
  ...
  endAction: r.element,
  onChange: r.func,
  size: r.oneOf(Object.keys(x.input)),
