...
const t = ({
  ...
  const o = h(b);
  return /* @__PURE__ */ r.createElement(E, { hint: s, error: l, id: o, required: f }, /* @__PURE__ */ r.createElement(x, { spacing: 1 }, i && /* @__PURE__ */ r.createElement(y, { action: m }, i), /* @__PURE__ */ r.createElement(
    R,
    {
      actions: n,
      label: i,
    ...
    d
  ), /* @__PURE__ */ r.createElement(L, null), /* @__PURE__ */ r.createElement(F, null)));
};
t.defaultProps = {
  actions: void 0,
  error: void 0,
