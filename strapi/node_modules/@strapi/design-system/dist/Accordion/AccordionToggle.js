...
import { AccordionTypography as I } from "./Accordion.js";
import { useAccordion as S } from "./AccordionContext.js";
...
`, Z = ({
  ...
  const {
    ...
    variant: k,
    disabled: n
  } = S(), T = `accordion-content-${s}`, m = `accordion-label-${s}`, z = `accordion-desc-${s}`, a = t === "M" ? 6 : 4, h = t === "M" ? a : a - 2, v = W({
    expanded: r,
    disabled: n,
    variant: k
  }), j = {
