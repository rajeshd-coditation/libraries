...
`, a = ({ children: e, outsideMonth: r, onSelectDay: p, isSelected: t, ...m }) => {
  let i = "neutral900";
  return t ? i = "primary600" : r && (i = "neutral600"), /* @__PURE__ */ l.createElement(c, { ...m }, /* @__PURE__ */ l.createElement(s, { tabIndex: -1, onClick: p, isSelected: t, type: "button" }, /* @__PURE__ */ l.createElement(n, { variant: "pi", textColor: i, fontWeight: t ? "bold" : null }, e)));
};
a.defaultProps = {
  isSelected: !1,
  outsideMonth: !1
