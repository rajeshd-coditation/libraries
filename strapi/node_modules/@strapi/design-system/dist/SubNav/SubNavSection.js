...
`, p = ({ collapsable: r, label: d, badgeLabel: o, children: s, id: m }) => {
  const [n, c] = f(!0), a = v(m), u = () => {
    c((i) => !i);
  };
  return /* @__PURE__ */ e.createElement(k, { spacing: 1 }, /* @__PURE__ */ e.createElement(C, { paddingLeft: 6, paddingTop: 1, paddingBottom: 1, paddingRight: 4 }, /* @__PURE__ */ e.createElement(l, { position: "relative", paddingRight: o ? 6 : 0 }, /* @__PURE__ */ e.createElement(
    E,
    {
      onClick: u,
      ariaExpanded: n,
