...
import { useTable as P } from "./RawTableContext.js";
...
const E = (r) => /* @__PURE__ */ g.createElement(h, { ...r, as: "th" }), h = ({ coords: r, as: T, ...x }) => {
  const s = w(null), { rowIndex: y, colIndex: v, setTableValues: p } = P(), [c, i] = R(!1), I = (e) => {
  ...
  }, [m]), /* @__PURE__ */ g.createElement(B, { role: "gridcell", as: T, ref: s, onKeyDown: I, ...x });
};
E.defaultProps = {
  children: void 0,
  coords: {}
