declare namespace Backbone {
  ...
  declare module codXeditor {
    ...
    interface Editor {
       ...
       */
      on(event: EditorEvent, callback: (...params: any[]) => any): Editor;
      /**
       * Attach event and detach it after the first run
       * @param event - Event name
       * @param callback - Callback function
       */
      once(event: EditorEvent, callback: (...params: any[]) => any): Editor;
      /**
       * Detach event
       * @param event - Event name
       * @param callback - Callback function
       */
      off(event: EditorEvent, callback: (...params: any[]) => any): Editor;
      /**
       * Trigger event
       * @param event - Event to trigger
       */
      trigger(event: EditorEvent): Editor;
      /**
       * Destroy the editor
       */
      destroy(): void;
    ...
    type EditorEvent = ComponentEvent
      | BlockEvent
      | AssetEvent
      | KeymapEvent
      | StyleManagerEvent
